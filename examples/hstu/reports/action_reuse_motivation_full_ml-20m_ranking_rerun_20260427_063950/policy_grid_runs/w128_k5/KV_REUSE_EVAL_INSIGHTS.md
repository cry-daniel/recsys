...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 42.46% | 0.809992 | -0.001714 | 0.001714 | 843,952 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 42.46% reuse but has max AUC drop 0.001714.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 42.46% reuse with mean AUC diff -0.001714.
