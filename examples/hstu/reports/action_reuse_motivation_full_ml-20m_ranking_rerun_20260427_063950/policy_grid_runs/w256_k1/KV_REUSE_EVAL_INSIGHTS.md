...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 18.12% | 0.809149 | -0.002557 | 0.002557 | 360,112 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 18.12% reuse but has max AUC drop 0.002557.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 18.12% reuse with mean AUC diff -0.002557.
