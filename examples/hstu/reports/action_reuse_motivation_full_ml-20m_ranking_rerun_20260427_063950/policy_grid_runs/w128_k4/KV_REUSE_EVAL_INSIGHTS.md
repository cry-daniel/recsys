...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 40.76% | 0.810051 | -0.001655 | 0.001655 | 810,240 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 40.76% reuse but has max AUC drop 0.001655.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 40.76% reuse with mean AUC diff -0.001655.
