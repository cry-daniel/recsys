...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 18.58% | 0.810968 | -0.000738 | 0.000738 | 369,256 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 18.58% reuse but has max AUC drop 0.000738.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 18.58% reuse with mean AUC diff -0.000738.
