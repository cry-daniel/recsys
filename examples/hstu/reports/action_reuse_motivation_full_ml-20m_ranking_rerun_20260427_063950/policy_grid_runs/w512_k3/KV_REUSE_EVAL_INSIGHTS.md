...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 37.99% | 0.808347 | -0.003359 | 0.003359 | 755,088 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 37.99% reuse but has max AUC drop 0.003359.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 37.99% reuse with mean AUC diff -0.003359.
