...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 0.00% | 0.811706 | +0.000000 | 0.000000 | 0 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 0.00% reuse but has max AUC drop 0.000000.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 0.00% reuse with mean AUC diff +0.000000.
