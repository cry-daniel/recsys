...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 37.88% | 0.809333 | -0.002373 | 0.002373 | 752,960 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 37.88% reuse but has max AUC drop 0.002373.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 37.88% reuse with mean AUC diff -0.002373.
