...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 29.68% | 0.810919 | -0.000787 | 0.000787 | 589,896 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 29.68% reuse but has max AUC drop 0.000787.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 29.68% reuse with mean AUC diff -0.000787.
