...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 48.12% | 0.698152 | -0.000066 | 0.001049 | 2,310,752 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 48.12% reuse but has max AUC drop 0.001049.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 48.12% reuse with mean AUC diff -0.000066.
