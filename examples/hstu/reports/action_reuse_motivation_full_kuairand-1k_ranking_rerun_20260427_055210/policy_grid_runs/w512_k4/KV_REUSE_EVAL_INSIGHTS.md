...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 47.57% | 0.698257 | +0.000039 | 0.000942 | 2,284,752 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 47.57% reuse but has max AUC drop 0.000942.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 47.57% reuse with mean AUC diff +0.000039.
