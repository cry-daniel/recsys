...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 47.91% | 0.698108 | -0.000110 | 0.000881 | 2,300,728 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 47.91% reuse but has max AUC drop 0.000881.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 47.91% reuse with mean AUC diff -0.000110.
