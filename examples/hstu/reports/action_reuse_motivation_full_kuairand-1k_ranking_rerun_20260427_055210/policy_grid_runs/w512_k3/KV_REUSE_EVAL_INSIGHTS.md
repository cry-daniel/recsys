...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 46.17% | 0.698261 | +0.000043 | 0.000762 | 2,217,080 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 46.17% reuse but has max AUC drop 0.000762.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 46.17% reuse with mean AUC diff +0.000043.
