...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 48.50% | 0.698036 | -0.000182 | 0.001080 | 2,329,264 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 48.50% reuse but has max AUC drop 0.001080.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 48.50% reuse with mean AUC diff -0.000182.
