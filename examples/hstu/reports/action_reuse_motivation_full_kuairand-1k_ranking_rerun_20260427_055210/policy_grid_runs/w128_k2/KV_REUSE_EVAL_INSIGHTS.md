...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 39.68% | 0.698129 | -0.000088 | 0.000383 | 1,905,552 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 39.68% reuse but has max AUC drop 0.000383.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 39.68% reuse with mean AUC diff -0.000088.
