...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 40.44% | 0.698394 | +0.000176 | 0.000375 | 1,942,304 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 40.44% reuse but has max AUC drop 0.000375.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 40.44% reuse with mean AUC diff +0.000176.
