...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 45.69% | 0.698030 | -0.000188 | 0.000514 | 2,194,272 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 45.69% reuse but has max AUC drop 0.000514.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 45.69% reuse with mean AUC diff -0.000188.
