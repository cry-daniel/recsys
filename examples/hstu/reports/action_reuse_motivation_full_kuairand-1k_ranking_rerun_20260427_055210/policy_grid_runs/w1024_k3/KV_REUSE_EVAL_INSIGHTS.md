...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 46.42% | 0.697890 | -0.000328 | 0.001456 | 2,229,376 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 46.42% reuse but has max AUC drop 0.001456.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 46.42% reuse with mean AUC diff -0.000328.
