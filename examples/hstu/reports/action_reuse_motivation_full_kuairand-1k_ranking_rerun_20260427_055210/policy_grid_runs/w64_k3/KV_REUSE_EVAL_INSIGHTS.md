...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 42.66% | 0.698144 | -0.000074 | 0.000391 | 2,048,744 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 42.66% reuse but has max AUC drop 0.000391.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 42.66% reuse with mean AUC diff -0.000074.
