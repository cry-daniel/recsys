...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 28.89% | 0.698428 | +0.000211 | 0.000313 | 1,387,232 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 28.89% reuse but has max AUC drop 0.000313.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 28.89% reuse with mean AUC diff +0.000211.
