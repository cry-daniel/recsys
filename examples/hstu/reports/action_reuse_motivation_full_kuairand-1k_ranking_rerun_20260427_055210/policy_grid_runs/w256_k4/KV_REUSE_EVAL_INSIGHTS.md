...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 46.93% | 0.698352 | +0.000134 | 0.000291 | 2,254,000 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 46.93% reuse but has max AUC drop 0.000291.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 46.93% reuse with mean AUC diff +0.000134.
