...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 45.66% | 0.698450 | +0.000232 | 0.000188 | 2,192,728 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 45.66% reuse but has max AUC drop 0.000188.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 45.66% reuse with mean AUC diff +0.000232.
