...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 29.17% | 0.698140 | -0.000078 | 0.000219 | 1,400,760 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 29.17% reuse but has max AUC drop 0.000219.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 29.17% reuse with mean AUC diff -0.000078.
