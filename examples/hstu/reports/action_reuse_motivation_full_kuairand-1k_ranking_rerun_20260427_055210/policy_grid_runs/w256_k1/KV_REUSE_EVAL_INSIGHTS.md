...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 29.09% | 0.698508 | +0.000290 | 0.000000 | 1,397,056 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 29.09% reuse but has max AUC drop 0.000000.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 29.09% reuse with mean AUC diff +0.000290.
