...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 40.19% | 0.698269 | +0.000051 | 0.000490 | 1,930,024 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 40.19% reuse but has max AUC drop 0.000490.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 40.19% reuse with mean AUC diff +0.000051.
