...
|---|---:|---:|---:|---:|---:|---:|---|
| window_topk_same_id:action | - | 28.96% | 0.698161 | -0.000057 | 0.000308 | 1,390,880 | yes |

## Takeaways

- Aggressive or semantically wrong reuse is the negative control: `window_topk_same_id:action` reaches 28.96% reuse but has max AUC drop 0.000308.
- Constrained same-action reuse is the useful regime: `window_topk_same_id:action` reaches 28.96% reuse with mean AUC diff -0.000057.
